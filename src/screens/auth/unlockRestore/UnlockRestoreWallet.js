...
const UnlockRestoreWallet = (props) => {
  ...
  return (
    <div className={classes.root}>
                ...
                <Box className={classes.bodyWrapper}>
                  <Typography variant="body1" className={classes.break}>
                    <ul style={{ padding: "0px 0px 0px 14px" }}>
                      ...
                      <li>
                        Each recovery phrase word must be separated with single
                        space and should not include anything like numbers ,
                        comma etc.
                      </li>
                      <li>
                        If you restore your account only main account will load.
                      </li>
                    </ul>
                  </Typography>
                </Box>
      ...
      <RestoreModal isOpen={isModalOpen} />
    </div>
  );
};
