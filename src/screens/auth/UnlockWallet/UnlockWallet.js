...
import { chainId, schema } from "../../../utils/contant";
...
import { activeAccount, activeIndex, setAccounts } from "../../../redux/wallet/actions";
...
const UnlockWallet = (props) => {
    ...
    const unlockWalletwithPassword = async (e) => {
        e.preventDefault();
        try {
            const key = fileEncryptionService.createEncryptionKey(state.values.password);
