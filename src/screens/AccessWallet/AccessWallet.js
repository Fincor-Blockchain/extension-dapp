          ...
          <Grid item xs={12}>
            <Box className={classes.main}>
              <Box className={classes.headingWrapper}>
                ...
                <Typography variant="h1">Welcome to Fincor Wallet </Typography>
              </Box>
              ...
              <Box className={classes.createWallet} onClick={routChange}>
                ...
                <Typography variant="h6">
                  Create a new wallet from 12 word seed phrase
                </Typography>
              </Box>
              <Box
                className={classes.createWallet}
                marginTop="20px"
                onClick={RestoreWalletHanler}
              >
                <img
                  src={createWallet}
                  alt="createWallet"
                ...
                <Typography variant="h6">
                  Restore a new wallet from 12 word seed phrase
                </Typography>
              </Box>
            </Box>
          </Grid>
