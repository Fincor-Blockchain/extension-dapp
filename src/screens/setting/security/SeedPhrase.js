...
import { Container, Typography, Box, Button, FormHelperText } from "@material-ui/core";
                ...
                <Box className={classes.main}>
                    <Box className={classes.bodyWrapper}>
                        <Typography variant="body1">
                            ...
                            Recovery Phrase to access your accounts. Save them somewhere safe and
                            secret.
                        </Typography>
                    </Box>
                    ...
                    <Box className={classes.checkBoxContainer}>
                        ...
                        <Typography className={classes.caution}>
                            ...
                            <br /> These words can be used to steal all your accounts.
                        </Typography>
                    </Box>
                    ...
                    <Typography className={classes.cancel} variant="body2" onClick={Cancel}>
                        Cancel Process
                    </Typography>
                </Box>
            </Container>
